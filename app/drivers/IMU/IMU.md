...
```text
app/drivers/IMU/icm42688p.c
app/drivers/IMU/icm42688p.h
app/drivers/IMU/imu_fusion.c
app/drivers/IMU/imu_fusion.h
app/drivers/IMU/app_imu.c
app/drivers/IMU/app_imu.h
```
...
建议 `EXTI4_IRQn` 优先级低于 DMA，例如 `2,0`。当前工程按这个思路配置。
